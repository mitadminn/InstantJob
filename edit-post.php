...
<div class="middle_container" id="myTabContent">
    <div class="tab-pane fade show active wrap_content_mid" id="one" role="tabpanel" aria-labelledby="one-tab">
        <div class="head-mid">
            <h2>Edit a Job Offer  <?=$_SESSION['Country'];?><b style="color: #ff0000;"></b></h2>
        </div>
        <form action="admin/inc/process.php?action=EditJob" method="post" class="service-form example" enctype="multipart/form-data">
      ...
      <input type=hidden name="postid" value="<?=$editjob['id'];?>">
            ...
            <textarea class="form-control" name="description" rows="4" placeholder="Write something here..." id="textbox" onkeyup="charcountupdate(this.value)" maxlength="1000" required><?=$editjob['description'];?></textarea>
                <label>Budget</label>
