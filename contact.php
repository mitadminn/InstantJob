<?php
    $page = 'Contact Us';
    include('inc/header.php'); ?><!--Start of Tawk.to Script-->
...
s1.async=true;
s1.src='https://embed.tawk.to/63f8c1da31ebfa0fe7ef1dc9/1gq1rag5v';
s1.charset='UTF-8';
s1.setAttribute('crossorigin','*');
s0.parentNode.insertBefore(s1,s0);
})();
</script>
<!--End of Tawk.to Script--><div class="">
<!-------- ASIDE SEC START -------->
<div class="row row-1">
<?php include('inc/sidebar.php'); ?>     
<!--first tab row start-->
<div class="row row-2">
    <div class="second-mid col-lg-8 ">
        <div class="head-mid">
            <h2>Contact</h2>
        </div>
    </div>
            ...
            <div class="">
                <div class="img-p-content">
                    <div class="img-pro-fl">
                        <img class="" src="https://mitdevelop.com/instajobs/assets/img/dcc2ccd9.avif" alt="">
                    </div>
        ...
        <div class="review-sec-profile">
            ...
            <div class="review-content">
                <div class="star-rating-img">
                    <img class="review-img" src="https://mitdevelop.com/instajobs/assets/img/dcc2ccd9.avif" alt="">
                </div>
