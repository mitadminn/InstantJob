...
<!--craousal section END-->
                ...
                <div class="scnd-bg-clr">
                    ...
                    <div class="myr">
                        <p class="jst-now">RM<?=$formattedPrice;?> <?//=$signle_job['price_type'];?></p>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <div  class="profile-mid_right_btns">
                            ...
                            <div>
                                ...
                                <!--<a href="discussion?dis_id=<?=$postuser['id']?>"><button class="sell_servc_btn">Send a message</button></a>-->
                            ...
                            <!--<div><button class="invt-job-intrvw" data-toggle="modal" type="button" data-target="#exampleModalCenter" value="<?//=$postuser['id'];?>">Invite for job interview</button> </div>-->
