...
/*}*/
  ...
  .switch input[type=checkbox]:checked + .slider {background-color: #000;}
...
.switch input[type=checkbox]:checked + .slider::before {transform: translateX(26px);  }
button.btn.btn-round.btn-default.active {    background: #323232;    color: #fff;    border: 1px solid #000;}
span.slider.round {position: absolute !important;right: 42px !important; top: 4px !important;}
p.off_wrap_btn {position: absolute;    top: 12px;    z-index: 0;    right: 48px;}
p.on_wrap_btn.text-light {position: absolute;    right: 74px;    top: 11px;}
p.pp2.no-posts {font-size: 16px; text-align: left; padding: 24px; height: 100px; font-family: 'Roboto';color: #707070; font-weight: 500;}
...
<div class="manage-section">
        ...
        <?php  
         $data_found = false; // Initialize flag variable
            while($rows = mysqli_fetch_array($allpoststogether)) {
                ...
                if($posttype == 'service') {  $myjs = 'MYS'; $page_edit = 'edit-service'; $page_dplct = 'duplicate-service'; $page_spnsr = 'post-sponsor';} elseif($posttype == 'job') {  $myjs = 'MYJ'; $page_edit = 'edit-post'; $page_dplct = 'duplicate-post'; $page_spnsr = 'job-sponsor';}else{}
                $price = $rows['price'];
              ...
              <div class="">
    <p class="status-id"><?php if($rows['status'] == '') { echo 'Waiting Approval';} elseif($rows['status'] == 1) { echo 'Active';} elseif($rows['status'] == 2) { echo 'Inactive';} elseif($rows['status'] == 3) { echo 'Completed';} elseif($rows['status'] == 4) { echo 'Rejected';}  ?> : Post ID - <?=$myjs;?><?=$rows['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end" style="">
                        ...
                        echo  '<label class="switch">';
                          echo '<input id="statuschange" type="checkbox" data-type="'.$posttype.'" data-id="' . $rows['id'] . '"';
                          if ($rows['status'] == 1) {
                            echo ' checked';
                          }
                          echo '>';
                          ...
                          echo '</label>'; } ?>
                             ...
                             <div class="icon-menu"  onclick="ExtraMenu(<?php echo $rows['random_id']; ?>)" data-id="<?=$rows['random_id'];?>">
                            ...
                            <div id="<?=$rows['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                               <a class="dropdown_menu" href="<?=$page_edit;?>?id=<?=$rows['id'];?>">Edit</a>
                                <a class="dropdown_menu" href="<?=$page_dplct;?>?id=<?=$rows['id'];?>">Duplicate</a>
                                <a class="dropdown_menu" href="<?=$page_spnsr;?>?id=<?=$rows['id'];?>&am=<?=$rows['price'];?>">Sponsor AD</a>
                                
                                <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $rows['id']; ?>)" data-type="<?=$rows['post_type'];?>">Delete</a>
                            </div>
                        </div>
        ...
        <!--End All posts by user-->
         ...
         <div class="all-services">
            ...
            $userinfo = $obj->GetUserById($userid);
             ...
             ?>
             <div class="">
    <p class="status-id"><?php if($row_active['status'] == '') { echo 'Waiting Approval';} elseif($row_active['status'] == 1) { echo 'Active';} elseif($row_active['status'] == 2) { echo 'Inactive';} elseif($row_active['status'] == 3) { echo 'Completed';} elseif($row_active['status'] == 4) { echo 'Rejected';} ?> :  Post ID - MYS<?=$row_active['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                        ...
                        <!--</div>-->
                         <?php 
                        if($row_active['status'] == 1 || $row_active['status'] == 2) { 
                        echo  '<label class="switch">';
  echo '<input  id="statuschange" data-type="'.$posttype.'" type="checkbox" data-id="' . $row_active['id'] . '"';
  ...
  echo '</label>'; } ?>
                             ...
                             <div class="icon-menu"  onclick="ExtraMenu(<?php echo $row_active['random_id']; ?>)" data-id="<?=$row_active['random_id'];?>">
                              <svg style="    position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$row_active['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="post-sponsor.php?id=<?=$row_active['id'];?>&am=<?=$row_active['price'];?>">Sponsor AD</a>
                                <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $row_active['id']; ?>)" data-type="<?=$row_active['post_type'];?>">Delete</a>
          ...
          <?php 
           $data_found = false; // Initialize flag variable
            ...
            $userinfo = $obj->GetUserById($userid);
             ...
             ?>
             <div class="">
    <p class="status-id">Waiting Approval : Post ID - MYS<?=$pending_service['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                             ...
                             <div class="icon-menu"  onclick="ExtraMenu(<?php echo $pending_service['random_id']; ?>)" data-id="<?=$pending_service['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$pending_service['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="post-sponsor.php?id=<?=$pending_service['id'];?>&am=<?=$pending_service['price'];?>">Sponsor AD</a>
                     <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $pending_service['id']; ?>)" data-type="<?=$pending_service['post_type'];?>">Delete</a>
     ...
     <div class="img-p">
          ...
          <?php } elseif($filter1 == 'services' && $filter2 == 'active') {   
            ...
            $posttype =  $active_service['post_type'];
             ...
             ?>
             <div class="">
    <p class="status-id">Active : Post ID - MYS<?=$active_service['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                        <?php 
                        if($active_service['status'] == 1 || $active_service['status'] == 2) { 
                        echo  '<label class="switch">';
  echo '<input  id="statuschange" data-type="'.$posttype.'" type="checkbox" data-id="' . $active_service['id'] . '"';
  ...
  echo '<span class="slider round"></span>';
   echo '<p class="off_wrap_btn">OFF</p>';
    echo '<p class="on_wrap_btn text-light">ON</p>';
  echo '</label>'; } ?>
                    <div class="icon-menu"  onclick="ExtraMenu(<?php echo $active_service['random_id']; ?>)" data-id="<?=$active_service['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$active_service['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                             <a class="dropdown_menu" href="edit-service?id=<?=$active_service['id'];?>">Edit</a>
                                ...
                                <a class="dropdown_menu" href="post-sponsor.php?id=<?=$active_service['id'];?>&am=<?=$active_service['price'];?>">Sponsor AD</a>
                                <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $active_service['id']; ?>)" data-type="<?=$active_service['post_type'];?>">Delete</a>
     ...
     <div class="img-p">
           ...
           <?php }elseif($filter1 == 'services' && $filter2 == 'inactive') { ?>
            ...
            $posttype =  $inactive_service['post_type'];
             ...
             ?>
             <div class="">
    <p class="status-id">Inactive : Post ID - MYS<?=$inactive_service['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                       <?php 
                        if($inactive_service['status'] == 1 || $inactive_service['status'] == 2) { 
                        echo  '<label class="switch">';
  echo '<input  id="statuschange" data-type="'.$posttype.'" type="checkbox" data-id="' . $inactive_service['id'] . '"';
  ...
  echo '</label>'; } ?>
                            ...
                            <div class="icon-menu"  onclick="ExtraMenu(<?php echo $inactive_service['random_id']; ?>)" data-id="<?=$inactive_service['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$inactive_service['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                             <a class="dropdown_menu" href="edit-service?id=<?=$inactive_service['id'];?>">Edit</a>
                                ...
                                <a class="dropdown_menu" href="post-sponsor.php?id=<?=$inactive_service['id'];?>&am=<?=$inactive_service['price'];?>">Sponsor AD</a>
                               <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $inactive_service['id']; ?>)" data-type="<?=$inactive_service['post_type'];?>">Delete</a>
                            </div>
                        </div>
    ...
    <?php if (!$data_found) {echo '<div class="nodatafound">
     <div class="img-p">
            ...
            $posttype =  $completed_service['post_type'];
             ...
             ?>
             <div class="">
    <p class="status-id">Completed : Post ID - MYS<?=$completed_service['random_id'];?></p>
    <div class="img-p">
                ...
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                       ...
                       <p class="on_wrap_btn text-light">ON</p>
                        ...
                        <div class="icon-menu"  onclick="ExtraMenu(<?php echo $completed_service['random_id']; ?>)" data-id="<?=$completed_service['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$completed_service['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="post-sponsor.php?id=<?=$completed_service['id'];?>&am=<?=$completed_service['price'];?>">Sponsor AD</a>
                                 <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $completed_service['id']; ?>)" data-type="<?=$completed_service['post_type'];?>">Delete</a>
     ...
     <?php }elseif($filter1 == 'services' && $filter2 == 'reject') {  
         ...
         while($rejected_service = mysqli_fetch_array($rejected_services)) {
            ...
            $posttype =  $rejected_service['post_type'];
             ...
             ?>
             <div class="">
    <p class="status-id">Rejected : Post ID - MYS<?=$rejected_service['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                        <div class="icon-menu"  onclick="ExtraMenu(<?php echo $rejected_service['random_id']; ?>)" data-id="<?=$rejected_service['random_id'];?>">
                              <svg style="    position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$rejected_service['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="post-sponsor.php?id=<?=$rejected_service['id'];?>&am=<?=$rejected_service['price'];?>">Sponsor AD</a>
                                 <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $rejected_service['id']; ?>)" data-type="<?=$rejected_service['post_type'];?>">Delete</a>
         ...
         <!--End all service only -->
          ...
          <!--Start all jobs only -->
           <div class="all-jobs">
            ...
            ?>
              <div class="">
    <p class="status-id"><?php if($aljobs['status'] == '') { echo 'Waiting Approval';} elseif($aljobs['status'] == 1) { echo 'Active';} elseif($aljobs['status'] == 2) { echo 'Inactive';} elseif($aljobs['status'] == 3) { echo 'Completed';} elseif($aljobs['status'] == 4) { echo 'Rejected';} ?> :  Post ID - MYJ<?=$aljobs['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                        ...
                        <!--</div>-->
                        <?php 
                        if($aljobs['status'] == 1 || $aljobs['status'] == 2) { 
                        echo  '<label class="switch">';
  echo '<input  id="statuschange" data-type="'.$posttype.'" type="checkbox" data-id="' . $aljobs['id'] . '"';
  if ($aljobs['status'] == 1) {
    echo ' checked';
  }
  echo '>';
  ...
  echo '</label>'; } ?>
                             ...
                             <div class="icon-menu"onclick="ExtraMenu(<?php echo $aljobs['random_id']; ?>)" data-id="<?=$aljobs['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$aljobs['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="job-sponsor.php?id=<?=$aljobs['id'];?>&am=<?=$aljobs['price'];?>">Sponsor AD</a>

                                <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $aljobs['id']; ?>)" data-type="<?=$aljobs['post_type'];?>">Delete</a>
    ...
    <?php } ?>
     ...
     <div class="img-p">
        ...
        //   if(!empty($waiting_jobs->num_rows)) {echo '<div class="app-act"> <h2>Waiting Approval</h2> </div>';}else{}
            ...
            ?>
              <div class="">
    <p class="status-id">Waiting Approval : Post ID - MYJ<?=$waiting_job['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                        ...
                        <div class="icon-menu"  onclick="ExtraMenu(<?php echo $waiting_job['random_id']; ?>)" data-id="<?=$waiting_job['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$waiting_job['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                             <a class="dropdown_menu" href="edit-post?id=<?=$waiting_job['id'];?>">Edit</a>
                                ...
                                <a class="dropdown_menu" href="job-sponsor.php?id=<?=$waiting_job['id'];?>&am=<?=$waiting_job['price'];?>">Sponsor AD</a>
                                 <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $waiting_job['id']; ?>)" data-type="<?=$waiting_job['post_type'];?>">Delete</a>
    ...
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                   <?php 
                        if($active_job['status'] == 1 || $active_job['status'] == 2) { 
                        echo  '<label class="switch">';
  echo '<input  id="statuschange" data-type="'.$posttype.'" type="checkbox" data-id="' . $active_job['id'] . '"';
  ...
  echo '</label>'; } ?>
                            ...
                            <div class="icon-menu"  onclick="ExtraMenu(<?php echo $active_job['random_id']; ?>)" data-id="<?=$active_job['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$active_job['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="job-sponsor.php?id=<?=$active_job['id'];?>&am=<?=$active_job['price'];?>">Sponsor AD</a>

                                <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $active_job['id']; ?>)" data-type="<?=$active_job['post_type'];?>">Delete</a>
    ...
    <?php if (!$data_found) {echo '<div class="nodatafound">
     <div class="img-p">
        ...
        //   if(!empty($inactive_jobs->num_rows)) {echo '<div class="app-act"> <h2>Inactive</h2> </div>';}else{}
            ...
            ?>
              <div class="">
    <p class="status-id">Inactive : Post ID - MYJ<?=$inactive_job['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                      <?php 
                        if($inactive_job['status'] == 1 || $inactive_job['status'] == 2) { 
                        echo  '<label class="switch">';
  echo '<input  id="statuschange" data-type="'.$posttype.'" type="checkbox" data-id="' . $inactive_job['id'] . '"';
  ...
  echo '</label>'; } ?>
                             ...
                             <div class="icon-menu"  onclick="ExtraMenu(<?php echo $inactive_job['random_id']; ?>)" data-id="<?=$inactive_job['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$inactive_job['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                <a class="dropdown_menu" href="edit-post?id=<?=$inactive_job['id'];?>">Edit</a>
                                <a class="dropdown_menu" href="duplicate-post?id=<?=$inactive_job['id'];?>">Duplicate</a>
                                <a class="dropdown_menu" href="job-sponsor.php?id=<?=$inactive_job['id'];?>&am=<?=$inactive_job['price'];?>">Sponsor AD</a>
                                 <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $inactive_job['id']; ?>)" data-type="<?=$inactive_job['post_type'];?>">Delete</a>
    ...
    <?php if (!$data_found) {echo '<div class="nodatafound">
     <div class="img-p">
        ...
        //   if(!empty($completed_jobs->num_rows)) {echo '<div class="app-act"> <h2>Completed</h2> </div>';}else{}
            ...
            ?>
              <div class="">
   <p class="status-id">Completed : Post ID - MYJ<?=$completed_job['random_id'];?></p>
    <div class="img-p">
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                          <div class="icon-menu"  onclick="ExtraMenu(<?php echo $completed_job['random_id']; ?>)" data-id="<?=$completed_job['random_id'];?>">
                              <svg style="position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$completed_job['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="job-sponsor.php?id=<?=$completed_job['id'];?>&am=<?=$completed_job['price'];?>">Sponsor AD</a>
                                 <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $completed_job['id']; ?>)" data-type="<?=$completed_job['post_type'];?>">Delete</a>
     ...
     <div class="img-p">
           ...
           while($rejected_job = mysqli_fetch_array($rejected_jobs)) {
            ...
            $userinfo = $obj->GetUserById($userid);
             ...
             <div class="">
    <p class="status-id">Rejected : Post ID - MYJ<?=$rejected_job['random_id'];?></p>
            ...
            <div class="all-cnt">
                <div class="d-flex two-lb align-items-center">
                    ...
                    <div class="jst-nw d-flex justify-content-end">
                             ...
                             <div class="icon-menu"  onclick="ExtraMenu(<?php echo $rejected_job['random_id']; ?>)" data-id="<?=$rejected_job['random_id'];?>">
                              <svg style="    position: absolute; right: 0; top: -11px;" class="dropbtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                              <path fill="currentColor" d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z" />
                            </svg>
                            <div id="<?=$rejected_job['random_id'];?>" class="text-left dropdown-contentt dropDown_links_post">
                                ...
                                <a class="dropdown_menu" href="post-sponsor.php?id=<?=$rejected_job['id'];?>&am=<?=$rejected_job['price'];?>">Sponsor AD</a>
                                <a class="dropdown_menu" id="delete" onclick="deletePost(<?php echo $rejected_job['id']; ?>)" data-type="<?=$rejected_job['post_type'];?>">Delete</a>
...
<!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.1.4/sweetalert2.min.css" integrity="sha512-2uL89puHLyIcMSw+duq3GqfNz/+HTpKk50Hkvh31O6UfpG6U/N7Vf1IeO8lVd5oi5u5ZBz5W6GXQ7MWgD2dJQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />-->

<!-- Include SweetAlert JS -->
<!--<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.1.4/sweetalert2.min.js" integrity="sha512-YrhZl1InncJbz+otNPQijHfo7YhM9X0/QPtlOGDgHwehqwrhLZG6Urq7VUwB6uI7Vfwm9AfC5k5d5H6m8Zm/zQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>-->
