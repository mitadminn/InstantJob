...
<div class="middle_container" id="myTabContent">
    <div class="tab-pane fade show active wrap_content_mid" id="one" role="tabpanel" aria-labelledby="one-tab">
        <div class="head-mid">
            <h2>Sell Your Service (Duplicate)<b  > </b></h2>
        </div>
        <div>
            <!-- for image and content -->
        </div>
        <form action="admin/inc/process.php?action=CreateService" method="post" id="duplicateform" class="service-form example" enctype="multipart/form-data">
